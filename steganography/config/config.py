...
class TrainConfig(BaseConfig):
    ...
    def __init__(self):
        ...
        self.batch_size = 6  # 一个批次的图片数量 # batch_size 会有影响
        ...
        self.reflection_trans_max = 0.05  # 反光的概率
        ...
        self.motion_blur_max = 1  # 给出的motion——blur的 核的最大值 （按照 2*k+1方式）  这个最大值是 实际中运动模糊实际的随机取值的最大值。
